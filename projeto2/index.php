...
<head>
  ...
  if ($_REQUEST['passagem']=="./img/descen.png")
  {
    foreach ($cli_p_j as $i=>$cli_j)
    {
      ...
      echo '</td>';
      echo '<td>';
      echo '<a href="mostra_cli.php?id='.$cod.'">'.$cli_j->getNome().'</a>';
      echo '</td>';
    ...
    foreach ($cli_p_f as $i=>$cli_f)
    {
      ...
      echo '</td>';
      echo '<td>';
      echo '<a href="mostra_cli.php?id='.$cod.'">'.$cli_f->getNome().'</a>';
      echo '</td>';
