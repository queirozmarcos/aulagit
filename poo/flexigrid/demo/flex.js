$(document).ready(function(){
 ...
 $(".flexme4").flexigrid({
                ...
                useRp : true,
                rp : 15,
                showTableToggleBtn : true, $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
                            ...
                            function(key, value){
                                ...
                                $.get('example4.php',
                                    { Edit: true
                                        ...
                                        , FavoritePet: FavoriteAnimal  }
                                    , function(){
                                        // when ajax returns (callback), update the g $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
            ...
            function Example4(com, grid) {
                ...
                else if (com == 'Edit') { $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
            ...
            function Example4(com, grid) { $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
                ...
                sortname : "iso", $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
                ...
                sortname : "iso",
                sortorder : "asc", $(".flexme4").flexigrid({
                url : 'example4.php',
                dataType : 'json',
                colModel : [ {
                    display : 'EmployeeID',
